        ...
        <div class="col-md-12">
            <div class="box box-danger">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form role="form" action="/shop/products/{{ $product->id }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                            ...
                                            <textarea name="description" id="description" value="" class="form-control" rows="5">{{ old('description', $product->description) }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group{{ $errors->has('price_discount') ? ' has-error' : '' }}">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" value="{{ old('price_discount', $product->price_discount) }}" name="price_discount" id="price_discount">
                                                <span class="input-group-addon">USD</span>
                                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <img src="{{ $product->image }}" id="image-url" style="display: block; width: 250px; height: 250px;">
